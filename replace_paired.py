...
def process_json_file(filename):
    ...
    if 'custom_liquid_t77pJf' in data.get('sections', {}):
        data['sections']['custom_liquid_t77pJf'] = {
            "type": "_blocks",
            "blocks": {
                "ai_gen_block_paired_new": {
                    "type": "ai_gen_block_paired",
                    "settings": {
                        "collection_handles": "led-mirrors,stylish-radiators-heated-towel-rails,luxury-shower-sets,toilets",
                        "per_collection": 3,
                        "title": "Customers Paired With",
        ...
        print(f"Could not find custom_liquid_t77pJf in {filename}")
